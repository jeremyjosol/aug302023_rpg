...
test('it should return the value of the attackMult function when the roll is greater than 14', () => {
  ...
  // expect(ranNumValue).toBeLessThan(1.6);
});
...
paulsCharacter.attackEnemy(jeremysCharacter, 1.5);
expect(jeremysCharacter).toEqual({name: "Jeremy", currentHp: 85, maxHp: 100, baseAttackPoints: 10, attackPoints: 10, armor: [], weapons: ["sword", 10 ,"knife", 7, "chicken", 5]});
});
